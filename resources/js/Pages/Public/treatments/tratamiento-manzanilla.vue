<script setup>
    import TreatmentLayout from '@/Pages/Public/treatments/TreatmentLayout.vue'
</script>


<template>
    <TreatmentLayout>
        <div class="relative py-16 bg-white overflow-hidden max-w-6xl mx-auto z-30">
            ...
            <div class="relative px-4 sm:px-6 lg:px-8 z-30">
                <div class="text-lg max-w-prose mx-auto">
                    <h1 class="mx-auto">
                        <span
                            class="block text-base text-center text-black font-semibold tracking-wide uppercase">Henna Method</span>
                        <span
                            class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Tratamiento de flor de manzanilla</span>
                    </h1>
                </div>
                <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
                    ...
                    <figure>
                        <img class="w-full rounded-lg"
                            src="/img/treatments/tratamiento-flor-manzanilla.jpeg"
                            alt="" width="1310" height="873" />
                        <figcaption>Sagittis scelerisque nulla cursus in enim consectetur quam.</figcaption>
                    </figure>
                    <h2>Everything you need to get up and running</h2>
                    <p>Purus morbi dignissim senectus mattis adipiscing. Amet, massa quam varius orci
