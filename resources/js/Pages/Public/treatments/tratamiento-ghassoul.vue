            ...
            <div class="relative px-4 sm:px-6 lg:px-8 z-30">
                <div class="text-lg max-w-prose mx-auto">
                    <h1 class="mx-auto">
                        ...
                        <span
                            class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Tratamiento de ghassoul</span>
                    </h1>
                </div>
                <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
                    ...
                    <figure>
                        <img class="w-full rounded-lg"
                            src="/img/treatments/tratamiento-ghassoul.jpeg"
